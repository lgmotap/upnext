...
Simple, mobile-first view of today's work. Responsive web in MVP (not native).

## Routes
`/crew` · `/crew/today` · `/crew/jobs/[jobId]`
...
## Later (native)
Push notifications · GPS check-in/out · offline mode · route directions · on-my-way notification · native photo capture.
