...
- **Job**: id, organizationId, bookingRequestId, customerId, customerAddressId, serviceId, title, scheduledStartAt, scheduledEndAt, status(scheduled|confirmed|in_progress|completed|cancelled|no_show), priceCents, currency, customerNotes, internalNotes, completionNotes, checkedInAt, completedAt, timestamps
