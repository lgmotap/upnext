...
- **Sprint 12 operations & growth**: ⌘K global search command palette, manual booking frequency selector, job **Send payment link** when Stripe connected, Playwright embed + crew RBAC tests. `npm run smoke:global-search`.
